...
# Read token from environment variable (Railway safe)
BOT_TOKEN = os.environ.get("8109112179:AAFOhMJF9XOfJPtWzCYClP7N28jcipPEb5Q")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Step 2: Confirmation
        ...
        await update.message.reply_text("📅 Please send booking date (YYYY-MM-DD):")
        session["step"] = "date"
    ...
    # Step 3: Date
        ...
        session["date"] = text
        session["step"] = "time"
        await update.message.reply_text("⏰ Please send time (HH:MM):")
